sap.ui.define(["./BaseController", "sap/ui/model/json/JSONModel", "../model/formatter", "sap/ui/model/Filter", "sap/ui/model/Sorter"],
	function (e, t, i, s, r) {
		"use strict";
		return e.extend("com.mindset.eam.equipmentLog.controller.Worklist", {
			formatter: i,
			onInit: function () {
			...
			handleSortButtonPressed: function () {
				this.createViewSettingsDialog("com.mindset.eam.equipmentLog.view.SortDialog").open()
			},
			handleFilterButtonPressed: function () {
				this.createViewSettingsDialog("com.mindset.eam.equipmentLog.view.FilterDialog").open()
			},
