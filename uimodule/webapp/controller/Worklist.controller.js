sap.ui.define(["./BaseController", "sap/ui/model/json/JSONModel", "../model/formatter", "sap/ui/model/Filter", "sap/ui/model/Sorter"],
	function (e, t, i, s, r) {
		"use strict";
		return e.extend("com.mindset.am.equipchangelog.controller.Worklist", {
			formatter: i,
			onInit: function () {
			...
			handleSortButtonPressed: function () {
				this.createViewSettingsDialog("com.mindset.am.equipchangelog.view.SortDialog").open()
			},
			handleFilterButtonPressed: function () {
				this.createViewSettingsDialog("com.mindset.am.equipchangelog.view.FilterDialog").open()
			},
